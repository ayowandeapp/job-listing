...
<div class="flex justify-center items-center mt-20">
    <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-500 mx-6">
        ...
        <form method="POST" action="/auth/register">
            <div class="mb-4">
                <input value="<?= $user['name'] ?? '' ?>" type="text" name="name" placeholder="Full Name"
            ...
            <div class="mb-4">
                <input value="<?= $user['city'] ?? '' ?>" type=" text" name="city" placeholder="City"
                    class="w-full px-4 py-2 border rounded focus:outline-none" />
            </div>
            <div class="mb-4">
                <input value="<?= $user['state'] ?? '' ?>" type=" text" name="state" placeholder="State"
                    class="w-full px-4 py-2 border rounded focus:outline-none" />
            </div>
            <div class="mb-4">
